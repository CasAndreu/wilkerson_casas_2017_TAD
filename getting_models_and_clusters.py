#==============================================================================
# getting_models_and_clusters.py
...
# LDA models can be used to classify documents into topics
# Getting the document classifications done by each estimated model
classifications = []
...
# Exporting CSV files for each classification/model
path = "/Users/andreucasas/Desktop/wilkerson_casas_2016_TAD/"
dir_name = "classifications/"
...
# Clustering the topics based on the cosine similarities and using Spectral
#   clustering.
# Trying several clusterings
