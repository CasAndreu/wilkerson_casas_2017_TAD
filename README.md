...
a. `01_getting_models_and_clusters.py`: Only run this script if you want the generate again main datasets used in the article. Skip otherwise: the `data` directory in this repository already contains the datasets needed to replicate the article's Figures.
...
This is a python script that does the following:
  ...
  - Classifies the speeches 17 according to the models and saves the classifications in `csv` fromat in the `data/classifications` directory.
